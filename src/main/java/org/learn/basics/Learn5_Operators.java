...
/**
 * In this class, we discuss operators.
 *
 * Read about the Summary of Operators: https://docs.oracle.com/javase/tutorial/java/nutsandbolts/opsummary.html
...
public class Learn5_Operators {
    ...
    public static void main(String[] args) {
         ...
         * Which is also known as assignment operator and '==' is known as equals-to operator
         * through which we compare two values.
         *
         * In the below-given example 'if' condition accepts boolean value, == is an 'operator'
         * myIntValue and 50 are 'operands' and myIntValue == 50 is an 'expression'.
         * myIntValue == 50, it means myIntValue is equal to 50 or not, true or false.
         */
        int myIntValue = 50;
        if (myIntValue == 50) {
         ...
         * which is a valid condition. This is not a recommended way; example is just
        ...
        if(!isMyChallengeReminderValueTrue){
             ...
             * '*' has high precedence than '+' so first it multiplies and then addition took place.
             * To get the correct output use below syntax.
