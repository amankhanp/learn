 ...
 * Technically, it's limited by memory.
 *
 * ### String in java is immutable ###
 * When I said you can delete characters out of String, that's not strictly true.
 * Because Strings in java are immutable. That means you can't change a String after it's created.
...
public class Learn4_String {
    ...
    public static void main(String[] args) {
         ...
         *
         * In net result it is the same, lastStringValue has the right values, however, a new
