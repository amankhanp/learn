...
/**
 * Concept: Method Overloading is a feature that allows us to have more than one method with the same name,
 * so as long as we use different parameters.
 *
 * It is an ability to create multiple methods of the same name with different implementations.
 *
...
public class Learn8_MethodOverloading {
     ...
     * You should validate that the first param minutes is >=0.
     * Also validate that the second param seconds is >=0 & <=59.
     * Then return "Invalid Value" in the method if either of the above is not true.
     *
